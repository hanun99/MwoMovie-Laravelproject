...
<nav class="navbar navbar-expand-lg navbar-dark ">
  <div class="container">
    ...
    <div class="lg-collap collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link" aria-current="page" href="/theater">Theaters</a>
        </li>
      </ul>
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link" aria-current="page" href="/order">Buy Tiket</a>
        </li>
      </ul>
      </ul>
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0 ml-lg-50">
        ...
        <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" aria-current="page" href="/register"><i class="bi bi-box-arrow-in-right"></i> Register</a>
          </li>
        @endauth
      </ul>
    </div>
