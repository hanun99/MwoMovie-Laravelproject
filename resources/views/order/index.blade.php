                ...
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        $.each(data.schedules, function(index, value){
                            $('#list-movie').append("<li id="+value.movie.id+" class='opt-movie'><img src="+value.
                            movie.bannerUrl+" alt='' width='30px' class='mr-3'><span class='my-auto'>"+value.movie.title+"</span></li>")
                        })
                    },
                    error: function (data, textStatus, errorThrown) {
                        console.log(data);
